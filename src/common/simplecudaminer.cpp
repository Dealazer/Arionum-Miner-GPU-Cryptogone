...
void SimpleCudaMiner::checkArgon(string *base, string *argon, string *nonce) {
    ...
    x << std::setw(2) << (int) sha[10];
    x << std::setw(2) << (int) sha[15];
    x << std::setw(2) << (int) sha[20];
    x << std::setw(2) << (int) sha[23];
    x << std::setw(2) << (int) sha[31];
    x << std::setw(2) << (int) sha[40];
    x << std::setw(2) << (int) sha[45];
    x << std::setw(2) << (int) sha[55];
    string dd = x.str();
